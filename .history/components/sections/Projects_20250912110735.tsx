    ...
    <section id="projects" className="relative overflow-hidden pt-14 pb-14">
      ...
      <div className="relative z-10  container-hero">
        ...
        <div className="relative mt-10">
          ...
          <div
            ref={trackRef}
            className="no-scrollbar mt-10 flex gap-6 overflow-x-auto snap-x snap-mandatory scroll-smooth px-6"
          >
            {PROJECTS.map((p) => (
              <article
                key={p.id}
                data-card
                className="snap-start shrink-0 w-[292px] sm:w-[332px] rounded-[16px] overflow-hidden
