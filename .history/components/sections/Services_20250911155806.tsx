  ...
  return (
    <section id="services" className="relative overflow-hidden py-28">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none select-none">
        ...
        />
        <Image
          src="public/gradients/blur-gradient-circle-transparent-ball-gradient-shining-circle-holographic-blurred-circles-rainbow-color-dots-abstract-gradient-shape-design-elements-free-png.png"
          alt=""
          width={1200}
          height={1200}
