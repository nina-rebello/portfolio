    ...
    <section id="services" className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none select-none">
        <Image
          ...
          width={1400}
          height={1000}
          className="absolute -top-40 left-[-220px] w-[1000px] opacity-80"
          priority
        />
        <Image
          ...
          width={760}
          height={760}
          className="absolute top-0 right-[-250px] w-[760px] opacity-70"
        />
      </div>

      {/* === faixa branca por cima dos gradientes === */}
      <div className="relative z-10 bg-white pt-20 pb-12 text-center">
