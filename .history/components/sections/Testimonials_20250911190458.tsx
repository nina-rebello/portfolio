          ...
          >
            {DATA.map((t, i) => (
              <div
                key={t.id}
                data-card="t"
                className={`group relative w-[84%] min-w-[84%] max-w-[84%] snap-center rounded-2xl bg-white shadow-2xl ring-1 ring-slate-200 transition-transform md:w-[560px] md:min-w-[560px] md:max-w-[560px] ${i === active ? "translate-y-0" : "translate-y-1"}`}
              >
                {/* quote mark */}
