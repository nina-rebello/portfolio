  ...
  {ITEMS.map((it, idx) => {
    ...
    return (
      <div
        ...
        data-index={idx}
        className="grid grid-cols-[1fr,64px,1fr] items-start gap-8"
      >
        ...
        >
          ...
          {it.description && (
            <p className="mt-2 text-slate-500 leading-relaxed max-w-[460px]">
              {it.description}
            </p>
          )}
        </div>
