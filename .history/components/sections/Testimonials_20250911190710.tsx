    ...
    <section id="testimonials" className="relative py-20">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <div className="relative mt-10">
          ...
          <div
            ref={trackRef}
            className="no-scrollbar relative -mx-60 flex snap-x snap-mandatory scroll-pl-4 gap-6 overflow-x-auto px-4 py-2"
          >
            {DATA.map((t, i) => (
              <div
                key={t.id}
                data-card="t"
                className={`group relative w-[84%] min-w-[84%] max-w-[84%] snap-center rounded-2xl bg-white shadow-[0_1px_0_rgba(2,6,23,0.04),0_24px_48px_-24px_rgba(2,6,23,0.18),0_60px_120px_-48px_rgba(2,6,23,0.22)] ring-1 ring-slate-200 transition-transform md:w-[560px] md:min-w-[560px] md:max-w-[560px] ${i === active ? "translate-y-0" : "translate-y-1"}`}
                {/* quote mark */}
