...
export default function Services() {
  return (
    <section id="services" className="relative overflow-hidden pb-0">
      {/* === gradientes de fundo === */}
      {/* === gradientes de fundo === */}
<div className="absolute inset-x-0 top-0 -bottom-[420px] -z-10 pointer-events-none select-none">
  <Image
  ...
  <Image
    ...
    width={860}
    height={860}
    className="absolute top-44 right-[-230px] w-[860px] opacity-70"
  />
</div>
