...
export default function Services() {
  return (
    <section id="services" className="relative overflow-hidden">
      ...
      <div className="bg-white pt-20 pb-12 text-center">
      ...
      {/* ===== Faixa gradiente (cards) ===== */}
      <div className="relative py-16">
        {/* gradientes de fundo */}
        <div className="absolute inset-0 z-0 pointer-events-none select-none">
          <Image src="/gradients/light-leak-blur-transparent-free-png.png" alt="" width={1400} height={1000} className="absolute -top-80 left-200 w-[1000px] opacity-80" priority /> <Image src="/gradients/blur-gradient.png" alt="" width={600} height={600} className="absolute top-4 right-250 w-[760px] opacity-70" />

          {/* fade branco -> transparente na emenda (igual ao mock) */}
