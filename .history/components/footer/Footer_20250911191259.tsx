...
export default function Footer() {
  return (
    <footer className="relative mt-24">
      ...
      <div className="mx-4 rounded-[28px] bg-white shadow-[0_1px_0_rgba(2,6,23,0.04),0_24px_48px_-24px_rgba(2,6,23,0.18),0_60px_120px_-48px_rgba(2,6,23,0.22)] md:mx-6">
