...
export default function Footer() {
  return (
    <footer className="relative mt-24">
      ...
      <div className="pointer-events-none absolute inset-x-0 -top-20 -z-10 h-48 bg-[radial-gradient(60%_80%_at_50%_100%,rgba(139,213,227,0.35),rgba(139,213,227,0)_60%)]" />
