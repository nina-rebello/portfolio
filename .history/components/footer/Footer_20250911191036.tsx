...
export default function Footer() {
  return (
    <footer className="relative mt-24">
      ...
      <div className="pointer-events-none absolute inset-x-0 -top-24 -z-10 h-48 bg-[radial-gradient(60%_80%_at_50%_100%,rgba(139,213,227,0.35),rgba(139,213,227,0)_60%)]" />

      {/* Card principal do footer */}
      <div className="mx-4 rounded-[28px] bg-white shadow-[0_1px_0_rgba(2,6,23,0.04),0_24px_48px_-24px_rgba(2,6,23,0.18),0_60px_120px_-48px_rgba(2,6,23,0.22)] ring-1 ring-slate-200 md:mx-6">
        ...
        <div className="border-t border-slate-200">
          <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-6 py-6 text-sm text-slate-500 md:flex-row">
            ...
            <div className="flex items-center gap-4">
              {/* Gmail */}
              <a href="mailto:hello@yourdomain.com" aria-label="Gmail" className="hover:opacity-80 transition">
                <svg viewBox="0 0 48 48" className="h-5 w-5"><path fill="#EA4335" d="M24 26.6 6 14.5V36c0 1.1.9 2 2 2h8V22l8 5.6 8-5.6v16h8c1.1 0 2-.9 2-2V14.5L24 26.6z"/><path fill="#FBBC04" d="M42 12h-4L24 21.4 10 12H6l18 12.6L42 12z"/><path fill="#34A853" d="M34 38V22l-10 7-10-7v16h20z"/><path fill="#C5221F" d="M42 12v24c0 1.1-.9 2-2 2h-8V22l10-7.3V12z"/><path fill="#1A73E8" d="M6 12v24c0 1.1.9 2 2 2h8V22L6 12z"/></svg>
              </a>
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/username" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="hover:opacity-80 transition">
              ...
              {/* YouTube */}
              <a href="https://youtube.com/@yourchannel" target="_blank" rel="noreferrer" aria-label="YouTube" className="hover:opacity-80 transition">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/5500000000000" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="hover:opacity-80 transition">
